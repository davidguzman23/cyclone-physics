...
namespace cyclone2
{
    ...
    public:
        /**
         * Fills the given contact structure with the contact needed to keep the cable
         * from overextending.
         */
        virtual unsigned addContact(ParticleContact *contact, 
    ...
    /**
     * Rods link a pair of particles, generating a contact if they stray too far apart
     * or too close.
     */
    ...
    */
    class ParticleContstraint : public ParticleContactGenerator
    {
    public: 
        /**
    ...
    * stray too far apart.
    */
    class ParticleCableConstraint : public ParticleContstraint
    {
    public:
        /**
        * Holds the maximum length of the cable.
    ...
    */
    class ParticleRodConstraint : public ParticleContstraint
    {
    public:
        /**
        * Holds the length of the rod.
