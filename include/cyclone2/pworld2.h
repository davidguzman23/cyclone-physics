...
namespace cyclone2
{
    ...
    {
    public: 
            typedef std::vector<Particle2*> Particles2;
    ...
    public:
         ...
         * give a number of contact-resolution iterations to use. If 
         * you don't give a number of iterations, the twice the number
         * of contacts will be used.
         */
        ...
        /**
         * Initializes the world for a simulation frame. This clears the
         * force accumulators for particles in the world. After calling 
         * this, the particles can have their forces for this frame 
         * added.
         */
        void startFrame();
    ...
    /**
     * A contact generator that takes an STL vector of particle pointers 
     * and collides them against the ground
     */
    class GroundContacts : public cyclone2::ParticleContactGenerator
    {
        cyclone2::ParticleWorld::Particles2 *particles;
    public:
        void init(cyclone2::ParticleWorld::Particles2 *particles);

        virtual unsigned addContact(cyclone2::ParticleContact *contact, unsigned limit) const;
    };
