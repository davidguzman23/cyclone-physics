...
namespace cyclone2
{
    ...
    protected:
         ...
         * can be used to set the acceleration due to gravity (its primary
    ...
    public:
        ...
        /**
         * Converts the given point from local space into the world
         * space.
         *
        ...
        /**
         * Converts the given direction from local space to 
         * world space.
         *
         * @note When a direction is converted between frames of
         * reference, there is no translation required.
