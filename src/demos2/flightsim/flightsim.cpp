 ...
 */
class FlightSimDemo : public Application2
{
    cyclone2::AeroControl left_wing;
    cyclone2::AeroControl right_wing;
    cyclone2::AeroControl rudder;
    cyclone2::Aero tail;
    cyclone2::RigidBody aircraft;
    cyclone2::ForceRegistry registry;

    cyclone2::Vector3 windspeed;
...
right_wing(cyclone2::Matrix3(0,0,0, -1,-0.5f,0, 0,0,0),
           cyclone2::Matrix3(0,0,0, -0.995f,-0.5f,0, 0,0,0),
           cyclone2::Matrix3(0,0,0, -1.005f,-0.5f,0, 0,0,0),
           cyclone2::Vector3(-1.0f, 0.0f, 2.0f), &windspeed),

left_wing(cyclone2::Matrix3(0,0,0, -1,-0.5f,0, 0,0,0),
          cyclone2::Matrix3(0,0,0, -0.995f,-0.5f,0, 0,0,0),
          cyclone2::Matrix3(0,0,0, -1.005f,-0.5f,0, 0,0,0),
          cyclone2::Vector3(-1.0f, 0.0f, -2.0f), &windspeed),

rudder(cyclone2::Matrix3(0,0,0, 0,0,0, 0,0,0),
       cyclone2::Matrix3(0,0,0, 0,0,0, 0.01f,0,0),
       cyclone2::Matrix3(0,0,0, 0,0,0, -0.01f,0,0),
       cyclone2::Vector3(2.0f, 0.5f, 0), &windspeed),

tail(cyclone2::Matrix3(0,0,0, -1,-0.5f,0, 0,0,-0.1f),
     cyclone2::Vector3(2.0f, 0, 0), &windspeed),
...
windspeed(0,0,0)
{
    ...
    cyclone2::Matrix3 it;
    it.setBlockInertiaTensor(cyclone2::Vector3(2,1,1), 1);
    aircraft.setInertiaTensor(it);

    aircraft.setDamping(0.8f, 0.8f);

    aircraft.setAcceleration(cyclone2::Vector3::GRAVITY);
...
void FlightSimDemo::display()
{
    ...
    cyclone2::Vector3 pos = aircraft.getPosition();
    cyclone2::Vector3 offset(4.0f+aircraft.getVelocity().magnitude(), 0, 0);
    ...
    cyclone2::Matrix4 transform = aircraft.getTransform();
...
void FlightSimDemo::update()
{
    ...
    cyclone2::Vector3 propulsion(-10.0f, 0, 0);
