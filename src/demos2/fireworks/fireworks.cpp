...
static cyclone2::Random crandom;

/**
 * Fireworks are particles, with additional data for rendering and
 * evolution.
 */
class Firework : public cyclone2::Particle2
{
public:
     ...
     * removed.
     */
    bool update(cyclone2::real duration)
    {
...
struct FireworkRule
{
     ...
     */
    void setParameters(unsigned type, cyclone2::real minAge, cyclone2::real maxAge,
        const cyclone2::Vector3 &minVelocity, const cyclone2::Vector3 &maxVelocity,
        cyclone2::real damping)
    {
    ...
    void create(Firework *firework, const Firework *parent = NULL) const
    {
        ...
        firework->setAcceleration(cyclone2::Vector3::GRAVITY);
 ...
 */
class FireworksDemo : public Application2
{
    /**
...
void FireworksDemo::initFireworkRules()
{
    ...
    rules[0].setParameters(
        1, // type
        0.5f, 1.4f, // age range
        cyclone2::Vector3(-5, 25, -5), // min velocity
        cyclone2::Vector3(5, 28, 5), // max velocity
        0.1 // damping
        );
    ...
    rules[1].setParameters(
        2, // type
        0.5f, 1.0f, // age range
        cyclone2::Vector3(-5, 10, -5), // min velocity
        cyclone2::Vector3(5, 20, 5), // max velocity
        0.8 // damping
        );
    ...
    rules[2].setParameters(
        3, // type
        0.5f, 1.5f, // age range
        cyclone2::Vector3(-5, -5, -5), // min velocity
        cyclone2::Vector3(5, 5, 5), // max velocity
        0.1 // damping
        );
    ...
    rules[3].setParameters(
        ...
        cyclone2::Vector3(-20, 5, -5), // min velocity
        cyclone2::Vector3(20, 5, 5), // max velocity
        0.2 // damping
        );
    ...
    rules[4].setParameters(
        5, // type
        0.5f, 1.0f, // age range
        cyclone2::Vector3(-20, 2, -5), // min velocity
        cyclone2::Vector3(20, 18, 5), // max velocity
        0.01 // damping
        );
    ...
    rules[5].setParameters(
        ...
        3, 5, // age range
        cyclone2::Vector3(-5, 5, -5), // min velocity
        cyclone2::Vector3(5, 10, 5), // max velocity
        0.95 // damping
        );
    ...
    rules[6].setParameters(
        7, // type
        4, 5, // age range
        cyclone2::Vector3(-5, 50, -5), // min velocity
        cyclone2::Vector3(5, 60, 5), // max velocity
        0.01 // damping
        );
    ...
    rules[7].setParameters(
        8, // type
        0.25f, 0.5f, // age range
        cyclone2::Vector3(-1, -1, -1), // min velocity
        cyclone2::Vector3(1, 1, 1), // max velocity
        0.01 // damping
        );
    ...
    rules[8].setParameters(
        9, // type
        3, 5, // age range
        cyclone2::Vector3(-15, 10, -5), // min velocity
        cyclone2::Vector3(15, 15, 5), // max velocity
        0.95 // damping
        );
...
{
    const static cyclone2::real size = 0.1f;
        ...
        firework++)
    {
        ...
        if (firework->type > 0)
        {
            ...
            const cyclone2::Vector3 &pos = firework->getPosition();
