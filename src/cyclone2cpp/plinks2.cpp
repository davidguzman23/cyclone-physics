                                    ...
                                    unsigned limit) const
{
    ...
    // Check whether we are over extended.
    if (length < maxLength)
    {
        return 0;
    }

    // Otherwise return the contact. // particles from ParticleLink are fed to ParticleContact
                                 ...
                                 unsigned limit) const
{
    ...
    // Check whether we are overextended.
...
real ParticleContstraint::currentLength() const
{
