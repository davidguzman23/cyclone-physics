...
void ParticleContact::resolveVelocity(real duration)
{
    ...
    {
        // The contact is either separating or stationary - there's no
        // impulse required.
        return;
    }
    ...
    // Check the velocity built-up due to acceleration only.
    ...
    // If all particles have infinite mass, then impulses will have no effect.
